...
// 创建符号
function createSymbol(data: string, version: number = 1, errorCorrectionLevel: any = ErrorCorrectionLevel.M): any {
  // 创建矩阵
...
// 主要导出函数
export function generateQRMatrix(data: string, version: number = 1, errorCorrectionLevel: any = ErrorCorrectionLevel.M): BitMatrix {
